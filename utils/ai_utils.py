...
# Khởi tạo OpenAI API với phiên bản 0.28.1
try:
    # Sử dụng openai API trực tiếp với phiên bản 0.28.1
    openai.api_key = OPENAI_API_KEY
    # Trong phiên bản 0.28.1, không cần tạo client OpenAI
    # Sử dụng openai module trực tiếp
